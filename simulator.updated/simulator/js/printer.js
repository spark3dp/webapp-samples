var Printer= (function() {
    ...
    */
    ...
    var getNewToken = function(){
        ...
        //Printer model, firmware and manufacturer
        var model = "Ember";
        var firmware = "1.1.1.1";
        var manufacturer = "Autodesk, Inc."

        var api_url = BASE_URL + "/print/printers/register?" + "model="+model+"&firmware="+firmware+"&manufacturer="+manufacturer;
    ...
    */
    var setPrintJobStatus=function(status){
        ...
        var api_url=BASE_URL+'/print/jobs/'+currentPrintCommand.command_token;
        log("Sending POST request to: "+api_url);
        log("POST data:"+JSON.stringify(acg));
